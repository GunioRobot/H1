...
public class ZooKeeperProvider implements Watcher,
		ThrowingProvider<ZooKeeper, SequencingException> {

	static final Logger LOG = LoggerFactory.getLogger(ZooKeeperProvider.class);
	protected static final String DEFAULT_SERVER_LIST_LOCATION = "/zkservers";
	protected static final String SERVER_LIST_LOCATION_PROPERTY = "com.talis.plaftform.sequencing.zookeeper.servers";

	protected static final int DEFAULT_SESSION_TIMEOUT = 10 * 1000;
	protected static final String SESSION_TIMEOUT_PROPERTY = "com.talis.plaftform.sequencing.zookeeper.session.timeout";

	protected static final int DEFAULT_CONNECTION_TIMEOUT = 10 * 1000;
	protected static final String CONNECTION_TIMEOUT_PROPERTY = "com.talis.platform.sequencing.zookeeper.connection.timeout";
